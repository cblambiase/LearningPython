...
html = urlopen("https://www2.aneel.gov.br/aplicacoes/indicadores_de_qualidade/decFecSegMensal.cfm?mes=5&ano=2021&regiao=SU&distribuidora=5707&tipo=d")
...
df = pd.DataFrame({'Col1': col1, 'Col2': col2, 'Col3': col3, 'Col4': col4, 'Col5': col5, 'Col6': col6, 'Col7': col7, 'Col8': col8, 
'Col9': col9, 'Col10': col10,'Col11': col11, 'Col12': col12, 'Col13': col13, 'Col14': col14, 'Col15': col15, 'Col16': col16, 
'Col17': col17, 'Col18': col18, 'Col19': col19, 'Col20': col20,'Col21': col21, 'Col22': col22, 'Col23': col23, 'Col24': col24,
 'Col25': col25})
df.head()
